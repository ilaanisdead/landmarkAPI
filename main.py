...
# MODEL= tf.saved_model.load("./1.h5")
MODEL = tf.keras.models.load_model("./1")
# os.chdir("D:/campus/final.year.project.datasets/landmarkapi")

# MODEL = keras.layers.TFSMLayer("1.h5", call_endpoint='serving_default')
